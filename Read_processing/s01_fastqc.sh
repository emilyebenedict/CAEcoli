...
basedir="$PWD"
rawin="/lts/gdlab/raw_data/seq5/240712_ESBLe_C3_WA"
...
fastqc ${cleanin}/${sample}_FW_clean.fastq ${cleanin}/${sample}_RV_clean.fastq ${cleanin}/${sample}_UP_clean.fastq -o ${cleanout} -$
RC=$?
set +x
